...
> **Gate / notes:** Submit at alternativeto.net as the maker (disclose it). List Bokal as an alternative to EditThisCookie and Cookie-Editor — that is the whole point of the directory and is not against its rules, unlike putting competitor names in a store listing. Evergreen: it keeps returning traffic for years.
